export default ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        // nft_mint_batch: IDL.Func(
        //     [ExtMintArgs, IDL.Opt(IDL.Principal), IDL.Nat32, IDL.Nat32],
        //     [],
        //     [],
        // ),
        ...
        //     [],
        // ),
        // nft_set_metadata_all: IDL.Func([IDL.Vec(IDL.Tuple(IDL.Nat32, IDL.Opt(MediaData)))], [], []),
        ...
        // nft_set_ownable_all: IDL.Func([NFTOwnable], [], []),
        // nft_set_ownable_by_token_index: IDL.Func([IDL.Nat32, NFTOwnable], [], []),
        // nft_set_ownable_by_token_index_batch: IDL.Func(
        //     [IDL.Vec(IDL.Tuple(IDL.Nat32, NFTOwnable))],
        //     [],
        //     [],
        // ),
        // nft_set_rarity: IDL.Func([IDL.Vec(IDL.Tuple(IDL.Text, IDL.Text))], [], []),
        // nft_set_rarity_all: IDL.Func([IDL.Text], [], []),
        ...
        // nft_set_thumbnail_all: IDL.Func([IDL.Opt(MediaData)], [], []),
        // nft_set_thumbnail_by_token_index: IDL.Func([IDL.Nat32, IDL.Opt(MediaData)], [], []),
        // nft_set_yumi_traits: IDL.Func([IDL.Vec(IDL.Tuple(IDL.Text, IDL.Text))], [IDL.Bool], []),
