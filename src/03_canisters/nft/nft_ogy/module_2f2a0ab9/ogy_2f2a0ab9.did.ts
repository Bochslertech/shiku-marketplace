export default ({ IDL }) => {
    ...
    CandyValue__1.fill(
        IDL.Variant({
            ...
            Array: IDL.Variant({
                thawed: IDL.Vec(CandyValue__1),
                frozen: IDL.Vec(CandyValue__1),
            }),
    ...
    //     Other: IDL.Text,
    // });
    // const Metadata_1 = IDL.Variant({ Ok: IDL.Vec(IDL.Nat), Err: NftError });
    // Vec.fill(
    //     IDL.Vec(
    //         IDL.Tuple(
    //             IDL.Text,
    ...
    // });
    // const Metadata_3 = IDL.Variant({ Ok: TokenMetadata, Err: NftError });
    ...
    Result_6.fill(IDL.Variant({ ok: ManageSaleResponse, err: OrigynError }));
    ...
    return IDL.Service({
        ...
        // balance_of_batch_nft_origyn: IDL.Func([IDL.Vec(Account)], [IDL.Vec(Result_19)], ['query']),
        // balance_of_nft_origyn: IDL.Func([Account], [Result_19], ['query']),
        // balance_of_secure_batch_nft_origyn: IDL.Func([IDL.Vec(Account)], [IDL.Vec(Result_19)], []),
        ...
        // bearer_batch_secure_nft_origyn: IDL.Func([IDL.Vec(IDL.Text)], [IDL.Vec(Result_17)], []),
        ...
        //     [],
        // ),
        // collection_update_nft_origyn: IDL.Func([ManageCollectionCommand], [Result_14], []),
        ...
        // dip721_metadata: IDL.Func([], [Metadata__1], ['query']),
        // dip721_name: IDL.Func([], [IDL.Opt(IDL.Text)], ['query']),
        // dip721_operator_token_identifiers: IDL.Func([IDL.Principal], [Metadata_1], ['query']),
        // dip721_operator_token_metadata: IDL.Func([IDL.Principal], [Metadata_2], ['query']),
        // dip721_owner_of: IDL.Func([IDL.Nat], [OwnerOfResponse], ['query']),
        // dip721_owner_token_identifiers: IDL.Func([IDL.Principal], [Metadata_1], ['query']),
        // dip721_owner_token_metadata: IDL.Func([IDL.Principal], [Metadata_2], ['query']),
        ...
        // dip721_token_metadata: IDL.Func([IDL.Nat], [Metadata_3], ['query']),
        // dip721_total_supply: IDL.Func([], [IDL.Nat], ['query']),
        // dip721_total_transactions: IDL.Func([], [IDL.Nat], ['query']),
        // dip721_transfer: IDL.Func([IDL.Principal, IDL.Nat], [Result__1], []),
        // dip721_transfer_from: IDL.Func([IDL.Principal, IDL.Principal, IDL.Nat], [Result__1], []),
        ...
        //     ['query'],
        // ),
        // manage_storage_nft_origyn: IDL.Func([ManageStorageRequest], [Result_11], []),
        // market_transfer_batch_nft_origyn: IDL.Func(
        //     [IDL.Vec(MarketTransferRequest)],
        //     [IDL.Vec(Result_10)],
        //     [],
        // ),
        market_transfer_nft_origyn: IDL.Func([MarketTransferRequest], [Result_10], []),
        // metadata: IDL.Func([], [Metadata__1], ['query']),
        // metadataExt: IDL.Func([TokenIdentifier], [Result_9], ['query']),
        ...
        //     ['query'],
        // ),
        nft_batch_origyn: IDL.Func([IDL.Vec(IDL.Text)], [IDL.Vec(Result_8)], ['query']),
        // nft_batch_secure_origyn: IDL.Func([IDL.Vec(IDL.Text)], [IDL.Vec(Result_8)], []),
        nft_origyn: IDL.Func([IDL.Text], [Result_8], ['query']),
        // nft_secure_origyn: IDL.Func([IDL.Text], [Result_8], []),
        // operaterTokenMetadata: IDL.Func([IDL.Principal], [Metadata_2], ['query']),
        // ownerOf: IDL.Func([IDL.Nat], [OwnerOfResponse], ['query']),
        // ownerTokenMetadata: IDL.Func([IDL.Principal], [Metadata_2], ['query']),
        sale_batch_nft_origyn: IDL.Func([IDL.Vec(ManageSaleRequest)], [IDL.Vec(Result_6)], []),
        ...
        //     [],
        // ),
        // stage_library_batch_nft_origyn: IDL.Func([IDL.Vec(StageChunkArg)], [IDL.Vec(Result_4)], []),
        // stage_library_nft_origyn: IDL.Func([StageChunkArg], [Result_4], []),
        // stage_nft_origyn: IDL.Func([IDL.Record({ metadata: CandyValue })], [Result_3], []),
