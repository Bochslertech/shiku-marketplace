...
import {
    ...
    OgyTokenActive,
    OgyTokenHistory,
    parseOgyAuctionToNftListing_47a7c018,
    parseOgyCollectionInfo_47a7c018,
    unwrapActiveRecords,
    unwrapHistoryRecords,
} from '..';
import idlFactory from './ogy_47a7c018.did';
import _SERVICE, {
    AuctionStateShared,
    BidResponse,
    CandyShared,
    ...
    return list.map((d, index) => {
        ...
        listing_data.listing = unwrapVariant1Map<AuctionStateShared, NftListing>(
            ...
            [
                'auction',
                (a) =>
                    parseOgyAuctionToNftListing_47a7c018(current_sale.sale_id, a, yumi_ogy_broker),
            ],
        );
        return listing_data;
    });
