...
import { OgyCandyValue_2f2a0ab9 } from '@/01_types/nft-standard/ogy-candy';
...
import {
    ...
    parseOgyCollectionInfo_2f2a0ab9,
    unwrapActiveRecords,
    unwrapHistoryRecords,
} from '..';
import idlFactory from './ogy_568a07bb.did';
import _SERVICE, {
    AuctionStateStable,
    BidResponse,
    CandyValue__1,
...
export const queryCollectionInfoByOgy = async (
    ...
    collection: string,
): Promise<OgyCollectionInfo_2f2a0ab9<OgyCandyValue_2f2a0ab9>> => {
    ...
    >(r, parseOgyCollectionInfo_2f2a0ab9, throwsBy(`can not query ogy info: ${collection}`));
};
            ...
            raw: {
                ...
                data: {
                    ...
                    account: unwrapVariant4(
                        ...
                        ['extensible', (s: CandyValue__1) => customStringify(s)],
                        [
                            'account',
                            (s: { owner: Principal; sub_account: [] | [Array<number>] }) => ({
    ...
    return list.map((d, index) => {
        ...
        listing_data.listing = unwrapVariant1Map<AuctionStateStable, NftListing>(
            ...
            [
                'auction',
                (a) =>
                    parseOgyAuctionToNftListing_be8972b0(current_sale.sale_id, a, yumi_ogy_broker),
            ],
        );
        return listing_data;
    });
