...
export type TransactionID__1 = { nat: bigint } | { text: string } | { extensible: CandyValue };
...
export default interface _SERVICE {
    ...
    // current_log: () => Promise<Array<LogEntry>>;
    ...
    // harvest_log: (arg_0: bigint) => Promise<Array<Array<LogEntry>>>;
    ...
    // log_history_page: (arg_0: bigint) => Promise<Array<LogEntry>>;
    // log_history_page_chunk: (
    //     arg_0: bigint,
    //     arg_1: bigint,
    //     arg_2: bigint,
    // ) => Promise<Array<LogEntry>>;
    // log_history_size: () => Promise<bigint>;
    ...
    // nuke_log: () => Promise<undefined>;
    // ownerOf: (arg_0: bigint) => Promise<OwnerOfResponse>;
    // ownerOfDIP721: (arg_0: bigint) => Promise<OwnerOfResponse>;
    ...
    // set_log_harvester_id: (arg_0: Principal) => Promise<undefined>;
