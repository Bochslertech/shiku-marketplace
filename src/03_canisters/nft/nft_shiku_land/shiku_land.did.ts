export default ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        // getAllSlots: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Nat, IDL.Nat))], ['query']),
        ...
        land_info: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Nat, LandProperty))], ['query']),
        ...
        // pending_transactions: IDL.Func([], [IDL.Vec(IndefiniteEvent)], ['query']),
